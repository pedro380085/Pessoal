...
<body>
	...
	<div id="content">
		...
		<section class="intro" id="intro">
            ...
            <p><?php echo _("Quando escrevi essa página pela primeira vez, eu optei por descrever em detalhes todas minhas conquistas nos últimos anos, mas realmente, quem se importa? A programação se tornou um hábito diário desde que completei quinze anos e, se me perguntar, é algo que faço muito bem. Mas no final, não importa o que save programa, mas sim para que sabe programar.") ?></p>
            
            <p class="subHeader"><?php echo _("A brief story of myself") ?></p>
            
            <p><?php echo sprintf(_("Quando estava no colégio, eu estudei pra caramba. Você vê, no Brasil as melhores universidades são públicas, totalmente financiadas pelo governo e abertas a qualquer pessoa disposta a fazer os exames de admissão. Eu amava tanto escrever código mas, ainda assim, tive que aprender todos os assuntos desnecessários para que pudesse entrar uma boa universidade e trabalhar apenas em meu código amado. E assim eu me tornei um aluno da %sUSP%s."), '<a href="http://www5.usp.br/">', '</a>') ?></p>

            <p><?php echo sprintf(_("No início, foi tudo incrível. Eu finalmente tive a liberdade que eu sempre quis (não só eu estava livre da escola, mas eu também comecei a viver em meu próprio), mas, como todos os truque de mágica, as coisas não ficam magicamente para sempre. O curso em si foi um ajuste ruim para mim, porque eu queria ser um Enginner Software e não um Enginner Computador. A diferença na redação pode ser pequeno, mas o conteúdo não é certamente, e assim, depois de dois anos, eu estava realmente frustated. Eu já tinha financiado a minha segunda empresa %sTrilha%s com um colega de classe, mas a minha vida acadêmica necessária para mudar, então eu decidi fazer um programa de intercâmbio (BSWB) por um ano. Fui aprovado, mas infelizmente não foi para a universidade eu queria, então eu recusei a oferta e se aproximou o Brasil como o ambiente onde minha empresa iria crescer."), '<a href="http://grupotrilha.com.br/">', '</a>') ?></p>

            <p><?php echo _("Mas nada disso importa quando você decidir se tornar um CEO Na nossa empresa, temos produtos que criou com base em tecnologia de ponta e até mesmo difícil de trabalhar dia e noite sobre ele, as pessoas realmente não parece se importar. E eles estão certos. Com o fluxo absurdo de informação que temos hoje em dia, somos exigentes com os detalhes eo processo de venda.") ?></p>

            <p><?php echo sprintf(_("Para endurecer as Habilidades necessárias, tais como ser um negotiatior melhor e strucking melhores negócios, eu tornou-se um participante ativo do Movimento Empresa Júnior no Brasil, o primeiro sendo um analista %sEESC jr.%s e, em seguida, um consultor de negócios em %sFEJESP%s. As pessoas tendem a trabalhar muito duro aqui, mas no geral eu fiz alguns bons amigos!"), '<a href="http://www.eesc.usp.br/eescjr/">', '</a>', '<a href="http://www.fejesp.org.br/">', '</a>') ?></p>

            <p><?php echo _("Para me divertir, eu tento ler o máximo possível. Normalmente, eu li algo em torno de 60 livros por ano, incluindo pelo menos 30k páginas. Algumas pessoas gostam de sair e se embebedar, eu prefiro ficar bêbado e ler. Ow, e você pode perguntar: o que eu ler tanto? E eu vou te responder: um monte de livros técnicos, thrillers e, quando eu estou sentindo um pouco triste, alguns livros de negócios.") ?></p>

            <p><?php echo _("E como meu exercício físico, eu tenho escolhido para montar minha bicicle pelo menos duas vezes por semana nas trilhas de São Carlos / SP. Você provavelmente vai encontrar-me correndo em algum lugar cheio de poeira e suor ;)") ?></p>
