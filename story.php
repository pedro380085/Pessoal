	...
	<div id="content">
		...
		<section class="intro" id="intro">
            ...
            <ul class="yearList">
                ...
                <li id="y21"><?php echo sprintf(_("Com 21 anos, o Garça não estava indo muito bem e aceitamos fazer um projeto de site para inscrições para uma semana acadêmica da USP. O sistema ficou pronto em menos de 10 dias e recebemos incríveis 100 reais de pagamento. Continuamos desenvolvendo o aplicativo, agora chamado %sInEvent%s, e realizamos mais algumas semanas acadêmicas. Ao final do ano concretizamos nosso primeiro contrato no valor de 11 mil reais. Nessa época o Nivaldo acabou saindo e o Neris e Giordano (colegas da USP) se tornaram sócios no projeto. Também decidimos encerrar as operações do Garça."), '<a href="https://inevent.us/">', '</a>') ?></li>
