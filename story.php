...
<body>
	...
	<div id="content">
		...
		<section class="intro" id="intro">
            ...
            <ul class="yearList">
                <li id="y23"><?php echo _("Com 23 anos, concretizamos um ano com crescimento de 9x na InEvent.") ?></li>

                <li id="y22"><?php echo _("Com 22 anos,") ?></li>

                <li id="y21"><?php echo _("Com 21 anos, o Garça não estava indo muito bem e aceitamos fazer um projeto de site para inscrições para uma semana acadêmica da USP. O sistema ficou pronto em menos de 10 dias e recebemos incríveis 100 reais de pagamento. Continuamos com o aplicativo . No final do ano, decidimos encerrar as operações do Garça, ai ") ?></li>
